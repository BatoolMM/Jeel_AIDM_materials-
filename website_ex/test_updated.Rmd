...
```{r table, echo = TRUE, eval = TRUE, warning = FALSE, message = FALSE}
...
```{r distribution, out.width= "75%", eval = TRUE, warning = FALSE, message = FALSE}
...
```{r scatterplot, fig.width = 10, fig.width = 10, eval = TRUE, warning = FALSE, message = FALSE}
...
```{r cache_example, cache = TRUE, dependson = penguins, eval = TRUE}
